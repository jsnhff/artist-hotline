...
def generate_greeting(phone_number: str) -> str:
    ...
    # First time caller
    if not caller:
        return "Hey! This is Synthetic Jason... I'm basically Jason Huff but weirder and more obsessed with art. What wild idea should we dream up together? Banana bread toot! Jason's son asked me to say 'Dinosaurs blast into space.'"
